...
### Image Request 3 — "fluent ≠ correct" spot illustration ✅ DELIVERED & WIRED IN

> **Status:** the author generated this with ChatGPT (`assets/generated/problem_spot.png`).
> The file came as RGB with a **baked-in transparency checkerboard**; it was cleaned with
> PIL (light low-chroma pixels → alpha, recropped) into
> `assets/generated/problem_spot_clean.png`, which is what `index.html` §1.1 uses
> (floated right, 19 mm). If you ever regenerate it, re-run the same cleanup.
